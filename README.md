...
<p>Credits to the original fork [author](https://github.com/asundr/gwent-classic) and the 3.1 [fork](https://github.com/asundr/gwent-classic)</p>
<p>A browser remake of the original Gwent minigame from The Witcher 3: Wild Hunt including all cards from the DLC.<br/>Click [here](https://renanb4.github.io/gwent-classic/) to play.</p>
<p>In addition to cloning the original game, various cards, faction, abilities and features have added to push the game even further.</p>
